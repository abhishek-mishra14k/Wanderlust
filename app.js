...
passport.serializeUser(User.serializeUser()); // this is used to serialize the user and store the user id in the session
...
app.use("/", usersRouter); // this is used to use the routes defined in the user.js file
